...
from neural_networks.losses import LossFunction, MeanSquaredError
from neural_networks.optimizers import Optimizer, SGD
...
if __name__ == '__main__':
    from data.dataset import Dataset
    from neural_networks.layers import Layer, DenseLayer, Dropout
    from neural_networks.activation import TanhActivation, SoftmaxActivation
    from neural_networks.losses import MeanSquaredError, CategoricalCrossEntropy
    from metrics.mse import mse
    from metrics.accuracy import accuracy
    from iobla.csv_file import read_csv

    # training data
    dataset = read_csv(r'C:\Users\gonca\Documents\GitHub\Portefolio_SI\datasets\iris\iris.csv', sep=',', features=True, label=True)
